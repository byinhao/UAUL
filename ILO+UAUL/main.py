...
def get_dataset(tokenizer, type_path, args):
    return ABSADataset(tokenizer=tokenizer, data_dir=args.dataset,
                       data_type=type_path, top_k=args.top_k, max_len=args.max_seq_length)
...
def train_function(args, seed):
    ...
    dataset = ABSADataset(tokenizer=tokenizer, data_dir=args.dataset,
                          data_type='dev', top_k=args.top_k, max_len=args.max_seq_length)
    ...
    if args.do_train:
        ...
        tfm_model = Quad_t5_model(args, args.model_name_or_path)
    ...
    if args.do_inference:
        ...
        test_dataset = ABSADataset(tokenizer, data_dir=args.dataset,
                                   data_type='test', top_k=args.top_k, max_len=args.max_seq_length)
        ...
        exp_settings = f"ILO+UAUL; Datset={args.dataset}; seed={args.seed}"
