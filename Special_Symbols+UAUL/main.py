...
if args.do_eval:
    ...
    sents, _ = read_line_examples_from_file(f'../data/{args.dataset}/test.txt', silence=False)
    ...
    exp_settings = f"Special+UAUL; Datset={args.dataset}; seed={args.seed}; gama={args.gama}; m={args.m}"
